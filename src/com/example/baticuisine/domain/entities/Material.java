...
public class Material extends Component {
    ...
    public Material(UUID id, String name, String componentType, double vatRate, Project project, double unitCost, double quantity, double transportCost, double coefficientQuality, Component component) {
